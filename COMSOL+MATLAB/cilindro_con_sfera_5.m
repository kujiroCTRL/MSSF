function out = model
%
% cilindro_con_sfera_5.m
%
% Model exported on Apr 16 2025, 17:23 by COMSOL 5.5.0.359.
...
model.label('cilindro_con_sfera_4.mph');
...
model.result.dataset('cln1').set('genpoints', {'0' '0.015' '0.01'; '1' '.015' '0.04'});
